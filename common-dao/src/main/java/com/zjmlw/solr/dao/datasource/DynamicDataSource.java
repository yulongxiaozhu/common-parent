package com.zjmlw.solr.dao.datasource;
...
//    private static final  logger = LogManager.getLogger(DynamicDataSource.class);
    ...
    protected Object determineCurrentLookupKey() {
        ...
        if (DynamicDataSourceHolder.isMaster()) {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("000000000000000000000 当前DataSource的key为: " + key);
            }
            return key;
        }
